  ...
  return (
    <Lightbox isOpen={lightboxProduct.isOpen}>
      ...
      <div className="flex flex-col gap-3 h-[400px] overflow-y-auto mt-3">
        ...
        <h2 className="font-semibold">{translate('TREASAURE_FABRICATION')}</h2>
        <div className="flex flex-col gap-2">
          <div className="flex flex-col">
            <p className="text-xs text-gray-400">
            ...
            <div className="flex flex-row gap-5">
              {lightboxProduct.product.large && (
                <div className="flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-sm">{lightboxProduct.product.large} cm</p>
                </div>
              )}
              {lightboxProduct.product.width && (
                <div className="flex flex-col justify-center items-center text-center">
                  <p className="text-xs text-gray-400">{translate('WIDTH')}</p>
                  <p className="text-sm">{lightboxProduct.product.width} cm</p>
                </div>
              )}
              {lightboxProduct.product.height && (
                <div className="flex flex-col justify-center items-center text-center">
                  <p className="text-xs text-gray-400">{translate('HEIGHT')}</p>
                  <p className="text-sm">{lightboxProduct.product.height} cm</p>
                </div>
              )}
              {lightboxProduct.product.diameter && (
                <div className="flex flex-col justify-center items-center text-center">
        ...
        <h2 className="font-semibold">{translate('TREASAURE_MULTIMEDIA_1')}</h2>
        <div className="pb-2">
