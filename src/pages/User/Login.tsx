  ...
  return (
    <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-xl">
      <div className="relative flex items-center justify-center mb-4">
        <h2 className="text-2xl font-semibold">Iniciar sessión</h2>
        <Link
          href="/"
          className="absolute right-0 text-2xl transform transition-transform  hover:scale-125 hover:text-yellow-400"
        >
          <IoClose />
        </Link>
      </div>
      ...
      <div className="flex w-full justify-center items-center mt-4">
        <p className="text-sm text-gray-500">Inicia sessión con</p>
      </div>
