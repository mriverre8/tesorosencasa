...
interface Props {
  initialTesoro: tesoros;
}

const ProductPageClient = ({ initialTesoro }: Props) => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col gap-2 max-w-lg">
        ...
        <Carousel tesoro={initialTesoro} />

        <div className="flex flex-col gap-3 rounded-md mt-4 mb-10">
          <div className="flex justify-between gap-5">
            <h1 className="text-2xl font-bold">{initialTesoro.name}</h1>
            <button
              onClick={() => handleShare(initialTesoro.id)}
          ...
          <div className="flex flex-col gap-3 mt-3">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col">
                ...
                <div className="text-sm">
                  {initialTesoro.condition?.length ? (
                    initialTesoro.condition.length === 1 ? (
                      <span>{Object.values(initialTesoro.condition)[0]}</span>
                    ) : (
                      <ul className="list-disc ml-5 pt-0.5">
                        {Object.values(initialTesoro.condition).map(
                          (cond, idx) => (
                            <li key={idx}>{cond}</li>
                          )
                        )}
            ...
            <div className="flex flex-col mobile:flex-row gap-2 ">
              <div className="flex flex-col w-full">
                ...
                <div className="text-sm">
                  {initialTesoro.material?.length ? (
                    initialTesoro.material.length === 1 ? (
                      <span>{Object.values(initialTesoro.material)[0]}</span>
                    ) : (
                      <ul className="list-disc ml-5 pt-0.5">
                        {Object.values(initialTesoro.material).map(
                          (mat, idx) => (
                            <li key={idx}>{mat}</li>
                          )
                        )}
            ...
            {(initialTesoro.large ||
              initialTesoro.width ||
              initialTesoro.height ||
              initialTesoro.diameter) && (
              <>
                <h2 className="font-semibold">
                ...
                <div className="flex flex-col mobile:flex-row gap-2 mobile:gap-10">
                  {initialTesoro.large && (
                    <div className="flex flex-col mobile:justify-center mobile:items-center mobile:text-center">
                      ...
                      <p className="text-sm">{initialTesoro.large} cm</p>
                    </div>
                  )}
                  {initialTesoro.width && (
                    <div className="flex flex-col mobile:justify-center mobile:items-center mobile:text-center">
                      ...
                      <p className="text-sm">{initialTesoro.width} cm</p>
                    </div>
                  )}
                  {initialTesoro.height && (
                    <div className="flex flex-col mobile:justify-center mobile:items-center mobile:text-center">
                      ...
                      <p className="text-sm">{initialTesoro.height} cm</p>
                    </div>
                  )}
                  {initialTesoro.diameter && (
                    <div className="flex flex-col mobile:justify-center mobile:items-center mobile:text-center">
                      ...
                      <p className="text-sm">{initialTesoro.diameter} cm</p>
                    </div>
                  )}
                </div>
              </>
            ...
            <div className="flex flex-col mobile:flex-row gap-2 mobile:gap-10">
              <div className="flex flex-col mobile:justify-center mobile:items-center mobile:text-center">
                ...
                <p className="text-sm">{initialTesoro.units}</p>
              </div>
              <div className="flex flex-col mobile:justify-center mobile:items-center mobile:text-center">
                <p className="text-xs text-gray-400 ">
                ...
                <p className="text-sm">{initialTesoro.price} €</p>
              </div>
            </div>
          </div>
        </div>
